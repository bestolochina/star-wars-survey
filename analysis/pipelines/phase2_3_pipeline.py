# analysis/pipelines/phase2_3_pipeline.py
...
from analysis.visualization.phase2_plots import (
...
def run_anova_phase(
    *,
    ...
    print(f"Saved → {figures_dir / "eta_squared_summary.png"}")
...
def run_phase_2_3(df: pd.DataFrame) -> None:
